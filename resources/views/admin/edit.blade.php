            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Form Edit Data Admin</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.update', $admin->kode_user) }}" method="POST">
                            @method('PATCH')
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text" disabled="" name="kode_user" class="form-control"
                                                value="{{ $admin->kode_user ?? old('kode_user') }}">
                                        </div>
                                        @error('id_admin')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                ...
                                                value="{{ $admin->name ?? old('name') }}" placeholder="John Doe">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="email"
                                                name="email"value="{{ $admin->email ?? old('email') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="no_telp"
                                                value="{{ $admin->no_telp ?? old('no_telp') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea name="alamat" rows="4" class="form-control" placeholder="Jln. Jendral Sudirman No 45">{{ $admin->alamat ?? old('alamat') }}</textarea>
                                </div>
                                @error('alamat')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
